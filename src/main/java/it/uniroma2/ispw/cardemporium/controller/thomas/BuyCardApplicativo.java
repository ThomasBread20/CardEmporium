...
import java.sql.SQLException;
 ...
 public class BuyCardApplicativo {
    ...
    public static ObservableList<CardEntity> searchCard(String name) throws SQLException, ExceptionCardNotExist {
    ...
    public ObservableList<CarrelloEntity> searchCard1(int id) throws SQLException, ExceptionCardNotExist, ExceptionDBerror {
         DatabaseBuyCardFacade cards = new DatabaseBuyCardFacade();
        try{
    ...
    public void refreshCardView(String nome, MouseEvent event, String set) throws ExceptionCardNotExist, SQLException, IOException, ExceptionSwitchpage {
        try{
           ...
           ObservableList<CardEntity> cards =  BuyCardApplicativo.searchCard( nome);
